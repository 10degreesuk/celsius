...
class Celsius {
	...
	public function enqueue_styles() {
        // Celsius css is loaded by snag.js 
    ...
    var celsius_api_key = "b6836f14cae0a823975683de850e701f";
    var celsius_account = "10degrees";
    </script>*/
	...
	public function enqueue_scripts() {
        ...
        if(get_option('celsius_enabled')==='enabled') {

            if(get_option('celsius_logged_in_only')=='true' && is_user_logged_in()) {

                $show_scripts = true;
                
            }elseif(get_option('celsius_logged_in_only')!='true') {
